...
#
#this file seems to use the pinout from the ESP01 with at commands for the sipeed nano m1n
    ...
    def reset(force=False, reply=5):
        ...
        for i in range(reply):
            ...
            if __class__._at_cmd(timeout=500):
                break
        __class__._at_cmd()
        __class__._at_cmd('AT+UART_CUR=115200,8,1,0,0\r\n', "OK\r\n")
        __class__.uart = UART(UART.UART2, 115200, timeout=1000, read_buf_len=10240)
